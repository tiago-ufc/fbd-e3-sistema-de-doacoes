...
INSERT INTO usuario (cpf_cnpj, nome, celular, email, estado, cidade, bairro, rua, numero, cep, senha) VALUES
('11122233344', 'Maria Silva Santos', '88991234567', 'maria.silva@email.com', 'CE', 'Quixadá', 'Centro', 'Rua A', '123', '63900000', 'senha123'),
...
-- Inserções de Doadores
INSERT INTO doador (cpf_cnpj_d, data_nascimento) VALUES
('11122233344','1985-03-15'),('22233344455','1990-07-22'),('33344455566','1978-11-30'),('44455566677','1982-05-10'),
...
-- Inserções de Beneficiários
INSERT INTO beneficiario (cpf_cnpj_b, data_nascimento) VALUES
('11122233345','1960-01-25'),('22233344456','1955-08-12'),('33344455567','1972-12-05'),('44455566678','1988-04-20'),
...
-- Inserções de Campanhas
INSERT INTO campanha (nome, data_inicio, data_fim, status, cpf_cnpj_i) VALUES
('Campanha do Agasalho 2024','2024-05-01', '2024-08-31', 'Ativa', '11222333000144'),
...
-- Inserções de Itens
INSERT INTO item_doacao (id_doacao, nome, descricao, estado_conservacao, peso, volume, tamanho, cor) VALUES
...
-- Inserções de Ordens de Doação
INSERT INTO ordem_de_doacao (data_hora_criacao, data_hora_retirada, status, estado, cidade, bairro, rua, numero, cep, cpf_cnpj_b, cpf_cnpj_i) VALUES
('2024-05-11 09:00:00','2024-05-12 14:00:00','Entregue','Ceará','Quixadá','Centro','Rua A','123','63900000','11122233345','11222333000144'),
